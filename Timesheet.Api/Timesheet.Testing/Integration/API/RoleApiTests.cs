...
public class RoleApiTests(WebApplicationFactory<Program> factory) : ApiTestsBase(factory)
{
    ...
    public async Task CreateRole_ReturnsOk()
    {
        ...
        var createdRole = await result.Content.ReadFromJsonAsync<RoleRDto>();
        ...
        var fetchedRole = await getResult.Content.ReadFromJsonAsync<RoleRDto>();
    ...
    public async Task UpdateRole_ReturnsOk()
    {
        ...
        var createdRole = await createResult.Content.ReadFromJsonAsync<RoleRDto>();
