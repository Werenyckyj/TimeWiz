...
export default function Companies() {
    ...
    const columns: ColumnDef<Company>[] = [
        ...
        { header: "Workers", accessor: "employees", type: "readonly", renderCell: (row) => row.employees?.filter((employee) => employee.isActive).length ? row.employees.filter((employee) => employee.isActive).length : "No workers" },
